        ...
        <div class="mb-20 md:mt-0">  
            ...
            <div class="flex space-x-4 mt-5">
                <a href="#" class="hover:opacity-75">
                    <img src="img/medsos/twitter.png" alt="Twitter" class="w-6 h-6">
                </a>
                <a href="#" class="hover:opacity-75">
                    <img src="img/medsos/ig.png" alt="Instagram" class="w-6 h-6">
                </a>
                <a href="#" class="hover:opacity-75">
...
</footer>  <?php /**PATH D:\Laragon\www\PathnityTechonnect\resources\views/components/footer.blade.php ENDPATH**/ ?>