...
<?php $component->withAttributes([]); ?>
    ...
    style="background-image: url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg');">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-36 ">
            <h1 class="mb-4 text-4xl font-medium tracking-tight leading-none text-white text-left pl-24 mt-32 ml-20">Find Job or Volunteer</h1>
            ...
            <p class=" text-2xl text-gray-300 text-left pl-24 mt-20 ml-20">We have a large selection of job or volunteer vacancies in
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white rounded-lg shadow-lg p-4">
                ...
                <div class="container mx-auto mt-5 ">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-white rounded-lg shadow-md p-8 border border-gray-300 h-48 lg:w-96 md:w-80">
    ...
    <div class="bg-[#241365] mt-11">  
        <div class="container mx-auto py-8">  
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8 ml-10 place-items-center h-auto max-w-full">  
                <div class="p-4">  
...
<?php endif; ?><?php /**PATH D:\herd\connect 11\resources\views/home.blade.php ENDPATH**/ ?>