<nav id="navbar" class="fixed top-0 left-0 w-full <?php echo e(request()->is('search') ? 'bg-primary shadow-lg' : 'bg-transparent'); ?>">
...
<?php /**PATH D:\Laragon\www\PathnityTechonnect\resources\views/components/navbar.blade.php ENDPATH**/ ?>