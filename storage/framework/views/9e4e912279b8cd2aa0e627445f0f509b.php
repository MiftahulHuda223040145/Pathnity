  ...
  <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
    <?php if(auth()->guard()->check()): ?>
      <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        ...
        <img class="w-8 h-8 rounded-full" src="<?php echo e(auth('web')->user()->avatar); ?>" alt="user photo">
      </button>

      <!-- Dropdown menu -->
      <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        <div class="px-4 py-3">
          <span class="block text-sm text-gray-900 dark:text-white"><?php echo e(auth('web')->user()->first_name . ' ' . auth('web')->user()->last_name); ?></span>
          <span class="block text-sm  text-gray-500 truncate dark:text-gray-400"><?php echo e(auth('web')->user()->email); ?></span>
        </div>
      ...
      <?php else: ?>
      <a href="/login" class="text-white text-sm font-medium hover:text-orange-300 <?php echo e(request()->is('login') ? 'text-[#FFA629]' : 'text-white hover:text-[#FFA629]'); ?>">
        SignIn/SignUp
      </a>
      <?php endif; ?>
...
<?php /**PATH D:\Kuliah\Semester 5\Praktikum Web\connect-11\resources\views/components/navbar.blade.php ENDPATH**/ ?>