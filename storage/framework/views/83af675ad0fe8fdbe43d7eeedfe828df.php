        ...
        <div class="flex bg-white shadow-lg w-full max-w-4xl">
            <form class="w-full p-6">
                ...
                <div class="flex items-start mb-6">
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full ssm:w-[400px] px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mb-3 ">
                        Submit
                    </button>
                    <p class="text-center">Already have an account?<a href="/login" class="text-orange-500 text-sm font-medium hover:text-orange-300 ml-1">
                        Sign In
                    </a></p>
...
<?php endif; ?>
<?php /**PATH D:\herd\connect\resources\views/register.blade.php ENDPATH**/ ?>