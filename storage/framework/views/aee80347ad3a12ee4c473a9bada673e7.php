        ...
        <div class="mx-auto py-8 place-items-center">
            <article class="mx-auto w-full max-w-4xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
                <div class="place-items-center px-12">
                    <img src="https://via.placeholder.com/800x400" alt="Gambar 2" class="mb-2"> 
                </div>
                <div class="px-12 ">
...
<?php endif; ?><?php /**PATH D:\Laragon\www\PathnityTechonnect\resources\views/blog/blog.blade.php ENDPATH**/ ?>