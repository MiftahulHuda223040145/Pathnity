document.addEventListener("DOMContentLoaded", () => {
    ...
    document
        .querySelectorAll(".data-birthday")
        ?.forEach((el) => (el.textContent = birthday));
    document
        .querySelectorAll(".data-gender")
        ?.forEach((el) => (el.textContent = gender));
    document
        .querySelectorAll(".data-country")
        ?.forEach((el) => (el.textContent = country));
    document
        .querySelectorAll(".data-city")
        ?.forEach((el) => (el.textContent = city));
