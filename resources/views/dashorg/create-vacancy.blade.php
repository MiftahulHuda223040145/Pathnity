<x-layout>
    <div class="p-4 bg-white rounded-lg mt-14 mx-auto">
        <div class="container mx-auto my-5">
            <form action="{{ route('vacancies.store') }}" class="max-w-sm mx-auto" method="POST"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="salary" name="salary"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ old('salary') }}" placeholder="Leave blank for no salary" />
                </div>
                <div class="mb-5">
                    <label for="numberofworker"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number Of Worker</label>
                    <input type="text" id="numberofworker" name="numberofworker"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required />
                </div>
