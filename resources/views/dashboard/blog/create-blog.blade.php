    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 bg-white rounded-lg mt-14">
            <div class="container mx-auto my-5">
                <form class="max-w-sm mx-auto" action="{{ route('blogs.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-5">
                    ...
                    <input id="body" type="hidden" name="body" name="description" value="">
