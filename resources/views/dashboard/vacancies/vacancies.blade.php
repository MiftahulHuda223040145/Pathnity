                    ...
                    <tbody>
                        @foreach ($vacanys as $vacancies)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    {{ $vacancies->category->name }}
                                </td>
                                <td class="px-6 py-4">
                                    {{ $vacancies->description }}
                                </td>
                                <td class="px-6 py-4">
                                    <a href="{{ route('vacancies.detail', $vacancies->id) }}" class="font-medium"><span
                                    ...
                                    <a href="{{ route('vacancies.edit', $vacancies->id) }}" class="font-medium"><span
                                    ...
                                    <form action="{{ route('vacancies.destroy', $vacancies->id) }}" method="POST"
                                        class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button
