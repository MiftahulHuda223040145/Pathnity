                ...
                <div class="overflow-hidden">
                    ...
                    <div class="p-10 flex flex-col items-start">
                        <div
                            ...
                            <img src="img/profile/profile.png" alt="Profile Image"
                    ...
                    <div class="p-10">
                        ...
                        <div class="flex mb-2">
                            ...
                            <p class="text-black">{{ $vacancy->location ?? 'Location not available' }}</p>
                        </div>
                        <div class="flex mb-2">
                            <svg class="w-6 h-6 text-gray-800 dark:text-white mr-2" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            ...
                            <p class="text-black">{{ $vacancy->type->name ?? 'N/A' }}</p>
                        </div>
                        <div class="flex mb-2">
                            <svg class="w-6 h-6 text-gray-800 dark:text-white mr-2" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        ...
                        <div class="mt-20">
                            <p class="mr-2 text-black">{{ $vacancy->description }}</p>
                        </div>
                    </div>
                </div>
            </div>
