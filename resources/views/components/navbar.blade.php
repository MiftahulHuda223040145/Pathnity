<nav id="navbar" class="fixed top-0 left-0 w-full z-50 {{ request()->is('search') ? 'bg-primaryDark shadow-lg' : 'bg-transparent' }}">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
    ...
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <!-- Dropdown menu -->
      <div class="z-40 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
        <div class="px-4 py-3">
