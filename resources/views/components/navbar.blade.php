<nav id="navbar"
    class="fixed top-0 left-0 w-full z-50 {{ request()->is('search') ? 'bg-primaryDark shadow-lg' : 'bg-transparent' }}">
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            @auth
                ...
                <div class="z-40 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <div class="px-4 py-3">
                        <span
                            class="block text-sm text-gray-900 dark:text-white">{{ auth('web')->user()->first_name . ' ' . auth('web')->user()->last_name }}</span>
                        <span
