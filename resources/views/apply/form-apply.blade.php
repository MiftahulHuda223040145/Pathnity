    ...
    <div class="bg-white rounded-lg shadow-2xl p-4 mt-5 h-auto mx-12">
        <div class="container mx-auto my-5">
            <form class="max-w-sm mx-auto">
                ...
                <button type="submit" class="text-black bg-[#FFA629] hover:bg-[#FFA629] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
            </form>
        </div>
    </div>
</x-layout>