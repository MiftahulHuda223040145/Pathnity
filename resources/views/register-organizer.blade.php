        ...
        <div class="flex bg-white shadow-lg w-full max-w-4xl">
            <form class="w-full p-6">
                ...
                <div class="relative mb-6">
                    ...
                    <span class="absolute inset-y-0 right-3 flex items-center cursor-pointer mt-8" onclick="togglePasswordVisibility('password', this)">
                        <img id="eye-icon-password" src="{{ asset('img/password/hidden.png') }}" alt="Show/Hide Password" class="w-5 h-5">
                    </span>
                </div>
                ...
                <div class="relative mb-6">
                    ...
                    <input type="password" id="confirm_password"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-10 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="•••••••••" required />
                    <span class="absolute inset-y-0 right-3 flex items-center cursor-pointer mt-8" onclick="togglePasswordVisibility('confirm_password', this)">
                        <img id="eye-icon-confirm-password" src="{{ asset('img/password/hidden.png') }}" alt="Show/Hide Password" class="w-5 h-5">
                    </span>
                </div>  
